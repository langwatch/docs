...
LangWatch provides SDKs for both Python and TypeScript to help you run batch evaluations on your datasets. This guide covers the basics of batch evaluations - for detailed API documentation, see our [Evaluation API Guide](/evaluations/experiments/code-first).
