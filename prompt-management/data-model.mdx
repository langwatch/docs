...
```json
{
  ...
  "handle": "proj_123/customer-support-bot",
  "scope": "PROJECT",
  "projectId": "proj_123",
  "organizationId": null,
...
- **`handle`**: Optional globally unique identifier (format: `projectId/prompt-name` for project scope or `organizationId/prompt-name` for organization scope)
