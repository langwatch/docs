...
description: "Interactive workspace for editing, testing, and iterating on prompts with AI assistance"
---

# Prompt Playground

The Prompt Playground is an interactive workspace that lets you edit, test, and iterate on prompts with real-time AI assistance. Work with multiple prompts simultaneously in a browser-like tab interface, test variations with variables, and get instant feedback through conversation testing.

<Frame>
  <img
    className="block"
    src="/images/prompts/prompt-playground-overview.png"
...
<video
  ...
  src="/media/videos/add-new-prompt.mp4"
  controls
  loop
  autoplay
  playsInline
...
<Frame>
  <img
    className="block"
    src="/images/prompts/prompt-playground-messages-editor.png"
...
Test your prompt interactively with AI assistance:

- Chat with the prompt using the current configuration
- See real-time responses as you edit
- Reset the conversation to start fresh
- The chat uses CopilotKit for AI-powered assistance

<Tip>
  The conversation tab automatically uses your current prompt configuration,
  including model settings and variables. Changes to your prompt are reflected
  in real-time.
</Tip>
...
<Frame>
  <img
    className="block"
    src="/images/prompts/prompt-playground-variables.png"
...
<Frame>
  <img
    className="block"
    src="/images/prompts/prompt-playground-split-view.png"
...
<Tip>
  This is particularly useful for debugging and improving prompts based on
