...
def generate_answer(question: str, contexts: list[str]) -> str:
    """
    Simulates an LLM generating an answer based on the retrieved contexts.
    """
    print(f"Generating answer for: '{question}'")
    # This simulates a good answer for the first question
    if "torque" in question.lower():
        return "The recommended torque setting for the Model A primary valve is 45 Nm."
    # This simulates a slightly incomplete answer for the second
    if "cooling system" in question.lower():
        return "The Model A cooling system should be flushed every 500 operating hours."
    # This simulates a faithful but less direct answer
    if "emergency shutdown" in question.lower():
        return "You can perform an emergency shutdown by using the red button on the main control panel, which cuts power."
    return "I am unable to answer that question based on the provided documents."
```
