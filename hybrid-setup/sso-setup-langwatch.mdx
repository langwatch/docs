...
We have setup the below providers for you. If you would like a different provider, please contact us at [support@langwatch.ai](mailto:support@langwatch.ai). 

For the full list of supported providers, see the [NextAuth.js documentation](https://next-auth.js.org/configuration/providers).
...
| Configuration      | Value                                                                                     |
| ------------------ | ----------------------------------------------------------------------------------------- |
| Required ENV Variables | `AUTH_AZURE_AD_CLIENT_ID`<br/>`AUTH_AZURE_AD_CLIENT_SECRET`<br/>`AUTH_AZURE_AD_TENANT_ID` |
