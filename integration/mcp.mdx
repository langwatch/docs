...
The [LangWatch MCP Server](https://www.npmjs.com/package/@langwatch/mcp-server) gives your AI coding assistant (Cursor, Claude Code, Codex, etc.) full access to all LangWatch and [Scenario](https://scenario.langwatch.ai/) documentation and features via the [Model Context Protocol](https://modelcontextprotocol.io/introduction).

- **Set up agent testing with [Scenario](https://scenario.langwatch.ai/)** to test agent behavior through user simulations and edge cases
...
4. Include code to run evaluations following [Evaluating via Code](/llm-evaluation/offline/code/evaluation-api)
