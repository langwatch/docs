...
<CodeGroup>
```bash npm
npm i langwatch mastra @mastra/core @ai-sdk/openai
```

```bash pnpm
pnpm add langwatch mastra @mastra/core @ai-sdk/openai
```

```bash yarn
yarn add langwatch mastra @mastra/core @ai-sdk/openai
```

```bash bun
bun add langwatch mastra @mastra/core @ai-sdk/openai
```
</CodeGroup>
