...
<Warning>
When using auto-instrumentation, you may need to configure data capture settings to control what information is sent to LangWatch. See the [data capture configuration](/integration/typescript/configuration#data-capture) documentation for details.
</Warning>
