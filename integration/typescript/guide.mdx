...
```bash
npm install langwatch @opentelemetry/sdk-node @opentelemetry/context-async-hooks @ai-sdk/openai ai
```
...
<Frame caption="Your first trace in the LangWatch dashboard">
<img src="/images/typescript-first-trace.png" alt="LangWatch dashboard showing a simple trace with input/output" />
</Frame>
...
<Frame caption="How traces and spans relate to your application">
<img src="/images/typescript-traces-spans.png" alt="Diagram showing traces containing multiple spans" />
</Frame>
...
<Note>
For detailed integration guides, see our [integration documentation](/integration/typescript/integrations).
</Note>
...
<Note>
For consistent attribute naming and TypeScript autocomplete support, see our [Semantic Conventions](/integration/typescript/tutorials/semantic-conventions) guide.
</Note>
...
- Verify network connectivity to api.langwatch.ai
...
- **[Advanced Patterns](/integration/typescript/tutorials/debugging-typescript)** - Debugging tracing in your application
- **[Manual Instrumentation](/integration/typescript/tutorials/manual-instrumentation)** - Getting the most out of tracing in your application
...
- **[OpenTelemetry migration](/integration/typescript/tutorials/opentelemetry-migration)** - Migrating your existing OpenTelemetry setup with LangWatch
- **[API Reference](/integration/typescript/reference)** - API reference for the LangWatch TypeScript SDK
