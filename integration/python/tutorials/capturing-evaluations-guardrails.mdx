...
- **Quality Assurance**:
    ...
    - **Server-Side**: Trigger a managed ["Toxicity" evaluator](/evaluations/evaluators/list) on LLM outputs, or use more open-ended approaches like an [LLM-as-a-judge](/evaluations/experiments/workbench/llm-as-a-judge) for tasks without predefined correct answers.
- **Compliance & Safety**:
