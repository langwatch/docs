<AccordionGroup>
  <Accordion title="Expected Answer Evaluation" description="For when you have the golden answer and want to measure how correct the LLM gets it">
  ...
  <Accordion title="LLM-as-Judge" description="For when you don't have a golden answer, but have a set of rules for another LLM to evaluate quality">
    | Evaluator                                | Description                |
    | -----------------------------------------|----------------------------|
  ...
  <Accordion title="RAG Quality" description="For measuring the quality of your RAG, check for hallucinations with faithfulness and precision/recall">
    | Evaluator                                | Description                |
    | -----------------------------------------|----------------------------|
  ...
  <Accordion title="Quality Aspects Evaluation" description="For when you want to check the language, structure, style and other general quality metrics">
    | Evaluator                                | Description                |
    | -----------------------------------------|----------------------------|
  ...
  <Accordion title="Safety" description="Check for PII, prompt injection attempts and toxic content">
    | Evaluator                                | Description                |
    | -----------------------------------------|----------------------------|
