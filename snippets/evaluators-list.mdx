...
| [Example Evaluator](/api-reference/evaluators/example-evaluator) | Use the Example Evaluator template in LangWatch to implement and test custom evaluation logic, such as word-count checks, before creating production-ready evaluators. |
