...
On the video below, we show how to use the LangWatch Experiments Workbench to evaluate a Business Coaching Agent, where we don't have defined answers, but we can use an LLM-as-a-judge to evaluate the quality of the answers:
