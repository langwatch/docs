...
Test your LLM on a dataset using the Experiments Workbench or via code:

<Tabs>
  <Tab title="Platform">
    Go to [Experiments](https://app.langwatch.ai/@project/evaluations) and click "New Experiment" to get started with the visual workbench.
  </Tab>
  <Tab title="Python">
```python
import langwatch

evaluation = langwatch.evaluation.init("my-first-experiment")
...
const evaluation = await langwatch.evaluation.init("my-first-experiment");
